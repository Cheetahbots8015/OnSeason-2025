    ...
    switch (systemState) {
      ...
      case POSITION:
        switch (systemPosition) {
          case L1:
            io.setPosition(ElevatorConstants.ELEVATOR_L1_POSITION);
            break;
          case L2:
            io.setPosition(ElevatorConstants.ELEVATOR_L2_POSITION);
            break;
          case L3:
            io.setPosition(ElevatorConstants.ELEVATOR_L3_POSITION);
            break;
          case L4:
            io.setPosition(ElevatorConstants.ELEVATOR_L4_POSITION);
            break;
          case LOW_ALGAE:
            io.setPosition(ElevatorConstants.ELEVATOR_LOW_ALGAE_POSITION);
            break;
          case HIGH_ALGAE:
            io.setPosition(ElevatorConstants.ELEVATOR_HIGH_ALGAE_POSITION);
            break;
          case PROCESSOR:
            io.setPosition(ElevatorConstants.ELEVATOR_PROCESSOR_POSITION);
            break;
          case STATION:
            io.setPosition(ElevatorConstants.ELEVATOR_STATION_POSITION);
            break;
          case LOLIPOP:
            io.setPosition(ElevatorConstants.ELEVATOR_LOLIPOP_POSITION);
            break;
          default:
            io.hold();
            break;
