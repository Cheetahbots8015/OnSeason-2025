...
public class ElevatorSystemIOKrakenX60 implements ElevatorSystemIO {
  ...
  public ElevatorSystemIOKrakenX60() {
    ...
    this.leader = new TalonFX(ElevatorConstants.ELEVATOR_LEFT_ID, ElevatorConstants.ELEVATOR_CANNAME);
    this.follower = new TalonFX(ElevatorConstants.ELEVATOR_RIGHT_ID, ElevatorConstants.ELEVATOR_CANNAME);
    ...
    followerConfigs.DifferentialConstants.PeakDifferentialDutyCycle = ElevatorConstants.ELEVATOR_PEAK_FORWARD_DUTY_CYCLE;
    ...
    followerConfigs.DifferentialSensors.DifferentialTalonFXSensorID = ElevatorConstants.ELEVATOR_LEFT_ID;
  ...
  public void updateInputs(ElevatorSystemIOInputs inputs) {
    ...
    inputs.positionDiff = leader.getPosition().getValueAsDouble() - follower.getPosition().getValueAsDouble();
    inputs.currentDiff = leader.getTorqueCurrent().getValueAsDouble()
        - follower.getTorqueCurrent().getValueAsDouble();
    inputs.voltageDiff = leader.getMotorVoltage().getValueAsDouble() - follower.getMotorVoltage().getValueAsDouble();
    inputs.dutyCycleDiff = leader.getDutyCycle().getValueAsDouble() - follower.getDutyCycle().getValueAsDouble();
