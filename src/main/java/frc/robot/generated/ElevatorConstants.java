...
public class ElevatorConstants {
    ...
    public static final double ELEVATOR_MOTION_MAGIC_ACCELERATION = 0.0;
    public static final double ELEVATOR_MOTION_MAGIC_CRUISE_VELOCITY = 0.0;
    public static final double ELEVATOR_MOTION_MAGIC_JERK = 0.0;
    ...
    public static final double ELEVATOR_L2_POSITION_RADS = 0.0;
