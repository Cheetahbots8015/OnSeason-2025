...
public class L4Command extends Command {
     ...
     */
    public L4Command(ElevatorSubsystem elevatorSubsystem, PivotSubsystem pivotSubsystem, RollerSubsystem rollerSubsystem) {
    ...
    public void execute() {
        ...
        if (m_elevatorSubsystem.isAtPosition(ElevatorConstants.L4Position) && m_pivotSubsystem.isAtPosition(PivotConstants.L4Position)) {
