...
public class L3Command extends Command {
     ...
     */
    public L3Command(ElevatorSubsystem elevatorSubsystem, PivotSubsystem pivotSubsystem, RollerSubsystem rollerSubsystem) {
    ...
    public void execute() {
        ...
        if (m_elevatorSubsystem.isAtPosition(ElevatorConstants.L3Position) && m_pivotSubsystem.isAtPosition(PivotConstants.L3Position)) {
